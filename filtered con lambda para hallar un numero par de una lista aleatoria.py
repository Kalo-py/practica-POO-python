...
# mientras es guiado por direcciones que fluyen desde la función especificada en el primer argumento 
...
#Nota: hemos hecho uso del módulo random para inicializar el generador de números aleatorios 
# (que no debe confundirse con los generadores de los que acabamos de hablar) con la función seed(), 
# para producir cinco valores enteros aleatorios de -10 a 10 usando la función randint().
